...
<html>
    <head>
        ...
        <script src="js/jquery-3.2.1.js"></script><!-- Se requiere para los departamentos -->
    ...
    <body>
        <div class="main-container">
            ...
            if (isset($_POST['enviar'])) {
                ...
                $destino = "archivos/" . $nombres . "_" . $nombre;
                $nombre_disco = $nombres . "_" . $nombre;
                ...
                $sql = "INSERT INTO cotizacion (nombres, apellidos, "
                        ...
                        . "dep_destino,ciudaddestino,tipocarga,empaque, numeroempaques, "
                        . "dimigual, ";
                ...
                $sql .= "fechamaxc, fechaminc,horaminc,horamaxc,librecargue,"
                        . "montacarga,fechamaxd, fechamind, horamind, horamaxd,"
                        . "libredescargue, montadescargue, detalleadicional) VALUES ( "
                        . "'$nombres', '$apellidos','$celular','$correo','$dep_origen', "
                        . "'$ciudadorigen', '$dep_destino','$ciudaddestino', "
                        . "'$tipocarga','$empaque','$numeroempaques','$dimiguales', ";
                for ($i = 1; $i <= $numeroempaques; $i++) {
                    $sql .= "'$alto[$i]', '$ancho[$i]','$largo[$i]', "
                            . "'$peso[$i]', ";
                }
                $sql .= "'$fechamaxc', '$fechaminc','$horaminc','$horamaxc',"
                ...
                <div class="body-container wrapper">
                    <div class="form-container">
                        <div id="formulario">
                            ...
                            <br>
                            <form action="" method="post" enctype="multipart/form-data" id="cotizacion">
