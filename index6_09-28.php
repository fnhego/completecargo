...
<html>
    <head>
        ...
        <link href="css/estilo6_09-28.css" rel="stylesheet" type='text/css' >
    </head>
    <body>
        <div class="main-container">
            ...
            <div class="body-container">
                ...
                <div class="cuerpo2">
                    <section id="section">
                        <div>
                            <h2 class="h2">Qué busca <img id="complete" src="img/logo_letters_gris.jpg" 
                                               width="114" height="27">?</h2>
                        </div>
                    ...
                    <section>
                        <div>
                            <h2 class="h2">Cómo lo hacemos?</h2>
                        </div>
                        <br><br>
