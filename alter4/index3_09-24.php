...
<html>
    ...
    <body>
        ...
        ?>
        <div class="body-container container-fluid wrapper col-lg-12">
            ...
            <div class="central-container">
                <div id="img">
                    ...
                    <img id="main" class="img-responsive" src="img/fondo_blue.jpg" width="1328" height="561">
                    <div class="botones bottom">
                        <input type="button" value="Transporta tu Carga" name="transporta" />
                        <a href="transportacarga.php">Transporta tu Carga</a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="conductor1.php">Registra tu Camión</a>
                        <input type="button" value="Registra tu Camión" name="registra" />
                    </div>
                </div>
            </div>
            ...
            <div class="cuerpo2">
                <section id="section" class="col-lg-12">
                    <div>
                        <h1>Qué busca <img id="complete" src="img/logo_letters_gris.jpg" 
                                           width="190" height="45">?</h1>
                    </div>
                    <p class="parrafo">Complete busca utilizar su tecnología para conectar a la mas 
                ...
                <section class="col-lg-12">
                    ...
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1 img-circle" src="img/1.jpg" >
                        <p>Recibimos la necesidad de Carga de nuestro Cliente.</p>
                    </div>
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1" src="img/2.jpg" width="150" height="100">
                        <p>Identificamos los Transportistas Aptos para la tarea y les informamos.</p>
                    </div>
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1" src="img/3.jpg" width="150" height="100">
                        <p>Recibimos las diferentes Ofertas y compartimos con nuestro Cliente.</p>
                    </div>
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1" src="img/4.jpg" width="150" height="150">
                        <p>Nuestro Cliente elige la opción de su preferencia.</p>
                    </div>
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1" src="img/5.jpg" width="150" height="100">
                        <p><font color="blue">Comienza el servicio.</font> Complete Cargo y el Cliente
                            hacen seguimiento en tiempo real.</p>
                    </div>
                    <div class="col-lg-2">
                        <img id="cuadro" class="cuadro col-lg-1" src="img/6.jpg" width="150" height="100">
